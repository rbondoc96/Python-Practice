...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
            In a panic, you throw the bomb at the group of Gothons ane make a
            leap for the door. Right as you drop it, a Gothon shoots you 
            right in the back, killing you. As you die, you see another
            Gothon frantically try to disarm the bomb. You die knowing
            ...
            punch the close button, and blast the lock so the Gothons can't get
            out. Now that the bomb is placed, you run to the escape pod off
            this tin can.
            """))
